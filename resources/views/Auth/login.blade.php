    ...
    <main class="flex h-full justify-center items-center px-2">
        <section class="w-full flex md:flex-row flex-col bg-white container gap-4">
            <div class="md:w-1/2 rounded-xl flex flex-col justify-center content-center">
                <img src="./images/3.jpeg" alt="img1" />
            </div>
            <div
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="grid md:grid-cols-2  grid-cols-1 gap-5 p-10">
                            ...
                            <div  class="flex gap-2">
                                    ...
                                    class="accent-primary_colour "   name="remember">
                                        <p class="text-text_primary">Remember me</p>
                                      </div>
                            </div>
                            </div>
                ...
                @if (Route::has('password.request'))
                <a class="text-primary_colour border-b-2 border-primary_colour"
